...
import * as probeConsoleMatrix from './probe-console-matrix.mjs';
import * as probeLcdHello from './probe-lcd-hello.mjs';
import * as probeContrast from './probe-contrast.mjs';
