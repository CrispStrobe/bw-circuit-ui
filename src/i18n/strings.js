...
const STRINGS = {
  ...
  scopeFooter:         { en: 'auto-ranging scale \u00b7 capture resets when the circuit is edited', de: 'automatische Skalierung \u00b7 Aufnahme wird bei Schaltungsänderung zurückgesetzt' },
